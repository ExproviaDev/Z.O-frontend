...
const MyQuizzes = () => {
  ...
  // ✅ 1. State Declaration (আপনার কোডে এই লাইনটি মিসিং ছিল)
    ...
    const fetchQuizData = async () => {
      try {
        ...
        const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/public-quizzes`, {
            params: { category: categoryToFetch }, // এখন "SDG Activist" বা "SDG Ambassador" যাবে
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div className="col-span-full py-20 text-center bg-white rounded-2xl border border-dashed">
            <p className="text-gray-400 text-lg">No active quizzes found for <b>{userCategory}</b>.</p>
          </div>
        )}
      </div>
    </div>
