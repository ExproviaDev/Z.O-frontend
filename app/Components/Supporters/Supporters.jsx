...
// Partner list with placeholder paths
const partners = [
  ...
  { name: "https://res.cloudinary.com/dsga4gyw9/image/upload/q_auto/f_auto/v1775294134/IMG_6539.JPG_gfckc0.jpg", logo: "https://res.cloudinary.com/dsga4gyw9/image/upload/q_auto/f_auto/v1775294134/IMG_6539.JPG_gfckc0.jpg" },
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-6 gap-y-10 items-center justify-center px-4">
          {partners.map((partner, index) => (
            <div 
              key={index} 
              className="group relative flex flex-col items-center justify-center p-2 rounded-full aspect-square bg-white border border-gray-100 shadow-sm hover:border-[#f1652230] hover:shadow-lg transition-all duration-500 ease-out"
            >
              {/* Circular Container for Logo */}
              <div className="relative w-full h-full rounded-full overflow-hidden grayscale group-hover:grayscale-0 opacity-80 group-hover:opacity-100 transition-all duration-500 ease-in-out">
                <Image
                  src={partner.logo}
                  alt={partner.name}
                  fill
              ...
              <div className="absolute -bottom-2 translate-y-full opacity-0 group-hover:opacity-100 group-hover:-translate-y-4 transition-all duration-500 ease-in-out pointer-events-none z-20">
                <div className="bg-gray-900 text-white text-[11px] px-3 py-1.5 rounded-lg shadow-xl whitespace-nowrap">
                  {partner.name}
                </div>
                {/* Tooltip Arrow */}
