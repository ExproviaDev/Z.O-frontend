...
export default function Sdg() {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: "07",
          sdg: "SDG 7",
          bn: "এসএসসি পরীক্ষার্থী",
          en: "O Level Candidate",
          madrasa: "দাখিল পরীক্ষার্থী",
        },
        {
          id: "08",
          sdg: "SDG 8",
        ...
        },
        {
          id: "10",
          sdg: "SDG 10",
          bn: "এইচএসসি পরীক্ষার্থী",
          en: "A Level Candidate",
          madrasa: "আলিম পরীক্ষার্থী",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          sdg: "SDG 11",
          bn: "১ম বর্ষ",
          en: "1st Year (Honors/Med/Eng)",
          madrasa: "ফাযিল / মেশকাত",
        },
        {
          id: "12",
          sdg: "SDG 12",
  ...
  return (
    <section
      id="sdg-mapping"
      className="py-24 bg-gray-200 overflow-hidden antialiased"
    >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-lg text-slate-500 font-medium leading-relaxed max-w-2xl">
              দ্বিতীয় রাউন্ডের ৩ মিনিটের ভিডিও থেকে নির্বাচিত ৫১ জন
              অংশগ্রহণকারীকে ঢাকায় গ্র্যান্ড ফিনালেতে আমন্ত্রণ জানানো হবে।
              আপনার নির্ধারিত SDG এবং ক্যাটাগরি দেখে নিন।
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="bg-indigo-600 p-6 rounded-[2rem] flex flex-col items-center justify-center min-w-[140px] shadow-xl shadow-indigo-200">
              ...
              <span className="text-[10px] font-black uppercase text-indigo-100 mt-1">
                Champions
              </span>
            </div>
          </div>
            ...
            <div key={idx} className="relative">
              ...
              <div className="grid lg:grid-cols-12 gap-12 items-start">
                <div className="lg:col-span-4 sticky top-24">
                  <div
                    className={`bg-gradient-to-br ${cat.color} p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden`}
                  >
                    <div className="absolute -right-8 -bottom-8 opacity-10">
                      <FaGraduationCap size={180} />
                    </div>
                    <h3 className="text-4xl font-black italic tracking-tighter mb-2 leading-none">
                      {cat.group}
                    </h3>
                    <p className="text-white/70 font-bold text-xs uppercase tracking-widest mb-10">
                      {cat.sub}
                    </p>

                    <div className="space-y-4">
                      <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                        <p className="text-[10px] uppercase font-black opacity-60 mb-1 tracking-tighter">
                          Winner Receives
                        </p>
                        <p className="font-bold text-lg">{cat.winnerTitle}</p>
                      </div>
                      <div className="bg-black/10 p-4 rounded-2xl border border-white/5">
                        <p className="text-[10px] uppercase font-black opacity-40 mb-1 tracking-tighter">
                          Others Receive
                        </p>
                ...
                <div className="lg:col-span-8 bg-slate-50/50 rounded-[3rem] border border-slate-100 p-8 md:p-12">
                  <div className="space-y-4">
                    {cat.items.map((item, i) => (
                      <div
                        key={i}
                        className="group flex flex-col md:flex-row md:items-center bg-white border border-slate-100 p-6 rounded-[2.5rem] transition-all hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-1"
                      >
                        <div className="flex items-center gap-6 md:w-1/3 mb-4 md:mb-0">
                          ...
                          <div>
                            ...
                            <h4 className="font-black text-slate-800 uppercase text-sm tracking-tight italic">
                              Global Goal Vision
                            </h4>
                          </div>
                        </div>
                        ...
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 border-t md:border-t-0 md:border-l border-slate-100 pt-4 md:pt-0 md:pl-8">
                          ...
                          <div>
                            ...
                            <p
                              className={`text-sm font-bold ${item.madrasa === "—" ? "text-slate-300" : "text-slate-600"}`}
                            >
                              {item.madrasa}
                            </p>
                          </div>
          ...
          <div className="bg-slate-900 rounded-[4rem] p-8 md:p-20 text-white relative overflow-hidden shadow-3xl">
            ...
            <div className="max-w-4xl relative z-10">
              <h3 className="text-4xl md:text-6xl font-black tracking-tighter italic leading-[0.9] mb-12">
                FROM THE STAGE <br />{" "}
                <span className="text-indigo-400">TO THE WORLD</span>
              </h3>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm leading-relaxed">
                        প্রতিটি SDG থেকে নির্বাচিত ৩ জন করে মোট ৫১ জনকে ঢাকায়
                        আসার আমন্ত্রণ জানানো হবে। সাথে আসতে পারবেন ২ জন অভিভাবক।
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h5 className="font-black text-xl mb-3">
                        PowerPoint Presentation
                      </h5>
                      <p className="text-slate-400 text-sm leading-relaxed">
                        নির্বাচিত ১৭ জন সেরা অংশগ্রহণকারী মঞ্চে তাদের SDG নিয়ে
                        পাওয়ারপয়েন্ট প্রেজেন্টেশন দেবেন।
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-10 rounded-[3rem] flex flex-col justify-center">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h5 className="font-black text-2xl uppercase tracking-tighter italic">
                      Zero Negative Impact
                    </h5>
                  </div>
                  <p className="text-slate-300 text-sm leading-relaxed mb-8">
                    তারা কীভাবে নির্ধারিত নেগেটিভ ইস্যুটিকে "Zero" করে লক্ষ্য
                    অর্জন করতে চায়—সেটিই হবে চূড়ান্ত রাউন্ডের মূল চ্যালেঞ্জ।
                  </p>
