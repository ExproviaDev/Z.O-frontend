...
export default function HeroSection() {
  const bgImages = ["https://res.cloudinary.com/dsga4gyw9/image/upload/v1766411372/IMG_8997_bl8xws.jpg", 
    "https://res.cloudinary.com/dsga4gyw9/image/upload/v1766411368/IMG_8763_hrsydw.jpg",
     "https://res.cloudinary.com/dsga4gyw9/image/upload/v1766411366/IMG_8710_lcvcsz.jpg"];
      ...
      <div className="relative z-10 max-w-6xl  mx-auto px-6 py-12 flex flex-col items-center text-center">
        ...
        <div className="mb-8">
          <span className="bg-white/10 backdrop-blur-xl border border-white/20 text-white px-6 py-2 rounded-full text-sm md:text-sm font-medium flex items-center gap-2 shadow-2xl">
            <span className="text-Primary animate-pulse"><IoIosStarOutline /></span> A Youth-Led Global Movement
          </span>
        </div>
